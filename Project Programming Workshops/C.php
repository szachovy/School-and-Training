...
<p style="font-weight: bold;font-style: italic; font-size: large; color: brown">Find after id</p>
<form>
    <textarea name="idarea"></textarea>
    <br/>
    <input name="sumbitid" type="submit" value="Sumbit" style="width: 11%;color: blueviolet"/>
</form>
<div align="right" style="margin-top: -8%;margin-bottom: 1%">
    <p style="font-weight: bold;font-style: italic; font-size: large; color: brown;margin-right: 1%">Find after user</p>
    <form>
        <textarea name="userarea"></textarea>
        <br/>
        <input name="sumbituser" type="submit" value="Sumbit" style="width: 11%;color: blueviolet"/>
    </form>
</div>
<?php
...
if ($result = $connection->query("SELECT * FROM ctopics")) {
    ...
    while ($amount != 0) {
        ...
        echo "<a href=cdiscuss.php?id=$n>forum</a>";
        '</td>';
        echo '<br/><br/>';
        echo '</tr>';
